    ...
    <section className="max-w-4xl mx-auto p-4">
      ...
      <div>
        <p className="">
          ...
          project with more of a focus centered around user profiles instead of
          schedule management. You can play around with the interactable demo{' '}
          <a
            href="https://hubworld.netlify.app/me"
            target="_blank"
            rel="noopener noreferrer"
        ...
        <p className="mb-4">
          ...
          on learning or improving a skill, I like to do so in the context of a
          full project - even if it never is fully released. In the case of{' '}
          <b>Hubworld</b>, I really wanted to focus on user interaction. As
          computer science major, I was never given the opportunity to formally
          learn or explore design, but in my career I have had to make design
          decisions and recommendations for projects I&apos;ve worked on. I
          wanted to grow in this area, so I spun up a{' '}
          <a
            target="_blank"
            rel="noopener noreferrer"
            className="underline"
          ...
          creation, authentication states, etc and all those fun things. I made
          sure to mock data and data fetching so that if I decide to revist and
          implement the functionality, the components should more or less be
          ready to go.
        </p>
        <p className="mb-4">
          Now that I have a strong foundation for the main views within{' '}
          <b>Hubworld</b>, I would love to add more interactions to the existing
          pages and then expand it with a few more screen before eventually
          fully implementing this design and the corresponding backend.
        </p>
      </div>
    </section>
  )
