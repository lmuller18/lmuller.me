      ...
      <section className="max-w-4xl mx-auto p-4">
        ...
        <div>
          <p className="mb-2">
            ...
            - <b>Raidr</b> is meant to solve the problem of scheduling large
            groups of people to get together and play a game. One of the hardest
            parts of a running a raid is getting everyone together in the same
            spot at the same time. <b>Raidr</b> allows the host to not only
            select the game being played, but also attach any number of links
            such as:
          </p>
          ...
          <p className="mb-2">
            ...
            peoples&apos; ideas is no fun. <b>Raidr</b> has often been a test
            bed for learning new ideas:
          </p>
          <ul className="list-interpunct ml-8 mb-4 text-sm">
            <li>
              Reading about Federated Servers? Implement Apollo Federation on
              the API layer.
            </li>
            <li>
          ...
          <p className="mb-2">
            Technologies that have been utilized in the different iterations
            have been:
          </p>
          <ul className="list-interpunct ml-8 mb-2 text-sm">
            <li>React</li>
