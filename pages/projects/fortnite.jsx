  ...
  return (
    <section className="max-w-4xl mx-auto p-4">
      ...
      <p className="text-xs opacity-50 mb-4">
        NOTE: Bell Icon not shown on HollowHead because this device did not have
      ...
      <div>
        ...
        <p className="mb-4">
          ...
          upcoming page. Whenever these items appeared back in the store, users
          would recieve a push notification - allowing you to make sure you
          didn&apos;t miss out on anything you were excited for.
        </p>
        <p className="mb-4">
          ...
          for the current season, a news page, basic user search and stats, and
          a page to manage all items the user was set to be notified about.
        </p>
        <p className="text-xs opacity-50 mb-4">
          NOTE: Unfortunately there is no official Fortnite API available. All
          data for this project was sourced and stitched together from multiple
          unoffical sources in 2018 which have since either stopped functioning
          entirely or have undergone breaking changes.
        </p>
      </div>
    </section>
  )
