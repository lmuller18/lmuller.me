...
const PUBG = () => {
  return (
    <section className="max-w-4xl mx-auto p-4">
      ...
      <div>
        <p className="mb-2">
          <b>PUBG Viewer</b> is an Angular PWA based around PUBG - specifically
          user and match stats. I was actively playing PUBG when the beta for
          the official API went live so I was extremely excited to dive into all
          of the data that was provided. Users can search for any account and
          view statistics per season and per match type (Solos, Duos, Squads,
        ...
        <p className="mb-4">
          ...
          being able to go to my own map after a match was over to breakdown how
          me and my friends did. The match details screen would load in all the
          stats for the player&apos;s team and the winning team to provide a
          good comparison. Each player was able to see which kills they got, who
          against, and with what weapon, as well as an accuracy breakdown which
          showed an SVG with color coding breaking down which areas the player
          did the most damage to throughout the match. These stats were derived
          from the raw match telemetry events and calculated on my API before
          being sent back to the user.
        </p>
        <p className="mb-4">
          The last piece of major functionality was the Replay tab on the match
          details screen. This took the telemetry data and drew the
